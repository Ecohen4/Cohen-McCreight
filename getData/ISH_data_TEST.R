...
setwd("/Users/elliotcohen/Dropbox/data/Cohen-McCreight/NOAA_ISH/") 
...
###################################################
##################################################
### Explore Temp-Energy Demand Relationships
##################################################
load("st.rsav")  # hourly temp data
dim(st)  # 1,236,851 x 14
sum(is.na(st))  # 0
...
#######################################
### chunk below updated and moved to Electricity Data Analysis for NR States
######################################
